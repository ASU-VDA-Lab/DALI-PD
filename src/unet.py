...
class EDAUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    _no_split_modules = ["CrossAttnDownBlock2D", "CrossAttnUpBlock2D", "UNetMidBlock2DCrossAttn", "DownBlock2D", "UpBlock2D"]
    r"""
    ...
    def __init__(
            ...
            norm_eps: float = 1e-5,
            cross_attention_dim: int = 1024,#1280,
            num_attention_heads: Union[int, Tuple[int]] = (5, 10, 20, 20),#8,
        ...
        reversed_attention_head_dim = list(reversed(num_attention_heads))
        ...
        self.wb = nn.Linear(4, 1024)
        self.wp = nn.Linear(2, 1024)
    ...
    def forward(
        ...
        encoder_hidden_states = self.wb(bbox_tensor) + self.wp(para_tensor)
