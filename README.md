...
## Model Weights
Model weights can be found on [Google Drive](). After downloading, please place the two folders in [src/Saved_Model](./src/Saved_Model/).

## Table of Content
  - [single-image.ipynb](./single-image.ipynb): Python notebook that shows how to use DALI-PD to generate synthetic circuit heatmaps.
