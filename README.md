...
## ASP-DAC version: [tag](https://github.com/ASU-VDA-Lab/DALI-PD/tree/ASP-DAC_2026)
...
## Model Weights
Model weights can be found on [ASU Dropbox](https://www.dropbox.com/scl/fo/o2ed8imhyaed9w89j5x96/AD8hzT4Z6h0y4tmmHy4Bkyo?rlkey=jlu3g4rrpkqawmjuk3fphtl1c&st=qiqc1jtq&dl=0). After downloading, please place them into folders in [models](./models/).
...
## Table of Content
  ...
  - [testset](./testset): Npz files of processed N28 testset.
